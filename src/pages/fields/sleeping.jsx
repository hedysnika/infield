export default function Sleeping() {
      ...
      <div>
        <div className="h-auto bg-white">
          <div className="text-black w-7/12 text-left p-6 py-16 ml-auto mr-auto text-lg ">
            ...
            <br />
            <p>
              Have you ever wondered why sleep is valuable? The average person
              spends one-third or nearly 230,000 hours sleeping in their lifetime.
              That can make getting in your 8 hours feel like a massive waste of
              time.
              <br /> <br />
              Many of us don’t know that getting enough rest is critical to
              optimizing the time we aren’t sleeping. Sleeping enough and sleeping
              well are essential for being productive during daylight hours.
              <br /> <br />
              Our brains need a compound called glucose to function optimally. And
              studies show that people who sleep less tend to have less glucose in
              their brain tissue. This phenomenon is mainly present in the
              prefrontal cortex, which helps us solve problems and perform more
              complex cognitive tasks.
              <br /> <br />
              Sleep handles everything from regulating our appetite and
              consolidating memories to strengthening immune system function and
              repairing damaged cells.
            </p>
            <h1 className="text-2xl font-bold"> 
            <br />
              StoryShot #2: Sun and Screen Exposure Can Throw Off Your Circadian
              Rhythm
            </h1>
            <br />
            <p>Humans need light. Since the dawn of human time, we’ve required sunlight to produce vitamin D. Our bodies can’t make this vitamin naturally. But we also need light because it regulates the circadian rhythm, aka our sleep-wake schedule.
  <br /><br />
  ...
  <br /> <br />
   ― SHAWN STEVENSON
            ...
            <h1 className="text-2xl font-bold">
            <br />  StoryShot #3: Temperature Is the Most Important Factor for Sleeping
              Well 
            </h1>
            <br />
            <p>Your body has not only an internal alarm clock but also an internal temperature regulator. The circadian rhythm regulates both processes.
  <br /><br />
  ...
  Don’t set your thermostat too low. Otherwise, you’ll need more blankets. More blankets can raise your internal body temperature and disrupt your sleep.
            ...
            <h1 className="text-2xl font-bold"> 
            <br />      
         StoryShot #4: Going to Bed at the Same Time and Waking Up Early Improves Sleep Quality </h1>
  ...
  <h1 className="text-2xl font-bold"> 
            <br />StoryShot #5: The More Diverse Your Gut Microbiome, the Better Your Sleep</h1>
  ...
  <p> 
            <br />
  Try to maintain regularity. Go to bed at the same time every night and wake up at the same time every morning. Do this irrespective of whether it is the weekend or a weekday. Even if you’ve had a bad night of sleep, still wake up at the same time of day and reset.
  <br /><br />
  ...
  <br /><br />
  Keep your sleeping environment as cool as possible. Many of us have a bedroom that’s too warm in terms of temperature. An optimal temperature is about 68 degrees Fahrenheit or about 18 and a half degrees Celsius. Your brain and body need to drop their core temperature by about two or three degrees Fahrenheit to initiate good sleep. Hence, you’ll always find it easier to fall asleep in a room that’s too cold than too hot. 
  <br /><br />
