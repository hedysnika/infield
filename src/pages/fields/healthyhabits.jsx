export default function healthyhabits() {
    return (
      <div>
        <div className="h-auto bg-white">
          ...
          <h1 className="text-2xl font-bold">Hydration</h1> <br />
          <p>   </p>
          Our bodies are incredibly efficient at adapting to their environment. If we only drink small amounts of water, our bodies will adapt and survive. Our bodies cannot operate at peak performance without sufficient water. Even slight dehydration causes our focus, physical performance, and mood to suffer.
          <br /> <br />
  ...
  <ul className="list-disc">
    ...
    <li>Headaches: The most common cause of headaches is dehydration. Drinking plenty of water will minimize your risk of getting headaches.
  </li>
    <li>Arthritis: Arthritis is often associated with existing injuries. However, it can also signify that your body is attempting to hold on to the sparing amounts of water left. Therefore, your body is restricting processes that contribute to water loss. One of these is joint movement.
  </li>
  </ul>
  <br />
  ...
  Finally, you must consider what type of water you are drinking. Your water may contain chemicals, organic materials, fluoride, chloride, and heavy metals. It is important to consider what is in our water because it is not static. Water constantly travels in and out of our cells, carrying nutrients and messages to the rest of our body. However, water molecules are suspended in electrolytes and must be small enough to fit through our cell membranes. Excess particles and other substances in the water we drink is detrimental to cell functioning. 
          ...
          <br />
          <h1 className="text-2xl font-bold"> Alkalization</h1> <br />
          <p>
